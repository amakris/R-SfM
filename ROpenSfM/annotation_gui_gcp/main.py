...
from annotation_gui_gcp import GUI
from annotation_gui_gcp.gcp_manager import GroundControlPointManager
from annotation_gui_gcp.image_manager import ImageManager
