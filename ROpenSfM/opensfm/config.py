...
bundle_analytic_derivatives: no    # Use analytic derivatives or auto-differentiated ones during bundle adjustment
bundle_refraction: no               # Use refraction. 
...
altitude_value: 103                   # Value when ingoring EXIF.
...
bundle_use_gimbal: no                 # Enforce gimbal rotation.
