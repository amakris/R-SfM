...
PYBIND11_MODULE(pymap, m) {
  ...
  py::class_<map::ShotMeasurements>(m, "ShotMeasurements")
      ...
      .def_readwrite("gimbal_accuracy", &map::ShotMeasurements::gimbal_accuracy_)
      .def_readwrite("gimbal_rotation", &map::ShotMeasurements::gimbal_rotation_)
      ...
      .def(py::pickle(
          [](const map::ShotMeasurements &s) {
            return py::make_tuple(s.gps_accuracy_, s.gps_position_,
                                  s.gimbal_accuracy_, s.gimbal_rotation_,
          ...
          [](py::tuple s) {
            ...
            sm.gimbal_accuracy_ = s[2].cast<decltype(sm.gimbal_accuracy_)>();
            sm.gimbal_rotation_ = s[3].cast<decltype(sm.gimbal_rotation_)>();
            sm.orientation_ = s[4].cast<decltype(sm.orientation_)>();
            sm.capture_time_ = s[5].cast<decltype(sm.capture_time_)>();
            sm.accelerometer_ = s[6].cast<decltype(sm.accelerometer_)>();
            sm.compass_angle_ = s[7].cast<decltype(sm.compass_angle_)>();
            sm.compass_accuracy_ = s[8].cast<decltype(sm.compass_angle_)>();
